...
from gen_patch_prompt import sf_construct_sig_prompt
...
def main():
    ...
    for function in functions_data:
        sig += function['function_name']

    prompt = sf_construct_sig_prompt(apr_info.dataset, apr_info.target_bug, dataset2, sig)
    # print(prompt)
