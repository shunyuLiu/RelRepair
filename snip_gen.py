...
from gen_patch_prompt import sf_construct_snip_prompt
...
def main():
    ...
    for function in functions_data:
        snip += function['function_name']


    prompt = sf_construct_snip_prompt(apr_info.dataset, apr_info.target_bug, dataset2, snip)
    # print(prompt)
